...
type mquerySRUTransformer struct {
...
func (s *mquerySRUTransformer) Transform(
	logRec servicelog.InputRecord,
	recType string,
	tzShiftMin int,
	anonymousUsers []int,
) (servicelog.OutputRecord, error) {
	tRec, ok := logRec.(*mquerysru.InputRecord)
	if ok {
...
func (k *mquerySRUTransformer) HistoryLookupItems() int {
	return k.t.HistoryLookupItems()
}

func (k *mquerySRUTransformer) Preprocess(

...
All the processing (reading, writing, handling multiple files) is performed
concurrently.
...
This is the mode which replaces CNC's LogStash solution and it is the most typical
mode to use probably. One or more log file listeners can be configured to read newly
